...
args=(
  # TOKEN_URL_OVERRIDE: when set (e.g. by a profile routing load through the
  # in-cluster nginx LB), it wins over PF_TOKEN_URL. Both stay https; k6's
  # INSECURE_SKIP_TLS_VERIFY applies to either endpoint.
  --from-literal=PF_TOKEN_URL="${TOKEN_URL_OVERRIDE:-${PF_TOKEN_URL}}"
