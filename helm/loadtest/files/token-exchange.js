...
async function doExchange() {
  ...
  // RFC 8707 resource: selects the access token manager by URI match. The
  // actor identity is NOT sent as actor_token — PingFederate builds the act
  // claim from the authenticated client id (context.ClientId) via the access
  // token mapping's OGNL expression.
